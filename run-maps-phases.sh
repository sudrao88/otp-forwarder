#!/bin/bash
# Unattended loop: implements one phase of MAPS_FEATURE_PLAN.md per iteration,
...
PLAN_FILE="MAPS_FEATURE_PLAN.md"
PROGRESS_FILE="MAPS_PROGRESS.md"
LOG_FILE="maps-phase-loop.log"
BRANCH="feature/maps-link-action"
TOTAL="${TOTAL:-6}"
...
while :; do
  ...
  claude -p --dangerously-skip-permissions \
    "Implement Phase $NEXT from $PLAN_FILE end-to-end. Follow the rules in CLAUDE.md. \
